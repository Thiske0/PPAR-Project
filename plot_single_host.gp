...
set style line 2 lw 2 pt 5   # OpenMP
set style line 3 lw 2 pt 9   # NUMA
set style line 4 lw 2 pt 11  # unused
...
plot \
  ...
  "results/final results/omp n 27 reduced.txt" using COL_N:COL_FILL  with linespoints ls 2 title "OpenMP", \
  "results/final results/numa h 1 n 27 reduced.txt" using COL_N:COL_FILL   with linespoints ls 3 title "NUMA"
...
plot \
  ...
  "results/final results/omp n 27 reduced.txt" using COL_N:COL_PROBE  with linespoints ls 2 title "OpenMP", \
  "results/final results/numa h 1 n 27 reduced.txt" using COL_N:COL_PROBE   with linespoints ls 3 title "NUMA"
...
plot \
  ...
  "results/final results/omp n 27 reduced.txt" using COL_N:COL_TOTAL  with linespoints ls 2 title "OpenMP", \
  "results/final results/numa h 1 n 27 reduced.txt" using COL_N:COL_TOTAL   with linespoints ls 3 title "NUMA"